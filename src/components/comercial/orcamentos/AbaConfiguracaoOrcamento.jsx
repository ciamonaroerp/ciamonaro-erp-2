...
export default function AbaConfiguracaoOrcamento({ orcamentoId, empresaId, garantirOrcamentoId, readOnly = false }) {
  ...
  const CAMPOS_FRONTEND = ["acabamentos_ids", "personalizacoes_ids", "personalizacoes_payload", "itens_adicionais_ids", "grupo_ids", "resumo_linha_artigo_cor", "nome_cor", "nome_linha_comercial", "observacoes"];
